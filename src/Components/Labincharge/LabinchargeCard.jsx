...
const LabinchargeCard = ({
  ...
  return (
    <div className="p-7 bg-white rounded-customRoundedBtn relative overflow-hidden group transform transition-transform duration-300 hover:translate-y-[-10px] h-[400px]">
