...
const LatestUpdate = () => {
  ...
  return (
    <section className="container mx-auto px-4 py-8">
      <div ref={contentRef} className={`flex flex-col md:flex-row items-center justify-center gap-8 ${contentInView ? "animate-fadeInUp" : ""}`}>
        ...
        <div ref={imageRef} className={`relative md:w-[70%] w-full h-64 md:h-auto ${imageInView ? "animate-slideInRight" : ""}`}>
          <video
            ref={videoRef}
            src={updateVideo}
